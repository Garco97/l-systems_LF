...
class GUI:
	...
	def create_GUI(self):
		...
		self.initial_state_entry.place(relx=0.17, rely=0.1)
		...
		self.iterations_entry.place(relx=0.755, rely=0.1)
		...
		self.variables_entry.place(relx=0.17, rely=0.3)
		...
		self.rules_entry.place(relx=0.17, rely=0.5)
		...
		self.angle_entry.place(relx=0.755, rely=0.3)
